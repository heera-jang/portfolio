<? 
	...
	$table = "adver";	// sql문에서 table명을 변수로 처리
?>
<!DOCTYPE html>
<html lang="ko">
<head>
	...
	<div class="wrap">
        ...
        <div class="sub_nav">
            <ul>
				...
				<li><a href="../news/list.php">동화뉴스</a></li>
                <li><a class="current" href="./list.php">동화광고</a></li>
            </ul>
        </div>
        <article id="content">
			<div class="title_area">
				<div class="line_map">
						<i class="fa-solid fa-house"></i> > 커뮤니티 > <strong>동화광고</strong>
				</div>
				<div><p>donghwa advertisement</p></div>
				<h2>동 화 광 고</h2>
			</div>
						...
						<ul class="lst_cont">
							<?		
								for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)                    
								{
									...
									$len_content = mb_strlen($item_content, 'utf-8'); //본문글의 총 길이
									if ($len_content > 20) // 제한글자수보다 크면
									{
									$item_content = mb_substr($item_content, 0, 20, 'utf-8');
