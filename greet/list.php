...
<?
	...
	if (!$scale){  //넘어오는 $scale의 값이 있으면.. 없으면...8
	...
	<div class="wrap">
        ...
        <article id="content">
			<div class="title_area">
                <div class="line_map">
                    <i class="fa-solid fa-house"></i> > 커뮤니티 > <strong> 공지사항</strong>
                </div>
			...
			<div class="content_area">
					...
					<div class="bbs_search">
						<form name="board_form" method="post" action="list.php?mode=search&liststyle=<?=$liststyle?>">
							...
							<input type="text" id="search" name="search" placeholder="검색어를 입력하세요" required>
