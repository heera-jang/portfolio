	...
	<div class="wrap">
        ...
        <div class="sub_nav">
            <ul>
				...
				<li><a  class="current" href="./list.php">동화뉴스</a></li>
                <li><a href="../adver/list.php">동화광고</a></li>
            </ul>
        </div>
        <article id="content">
			<div class="title_area">
				<div class="line_map">
						<i class="fa-solid fa-house"></i> > 커뮤니티 > <strong>동화뉴스</strong>
				</div>
				<div><p>donghwa news</p></div>
				<h2>동 화 뉴 스</h2>
			</div>
