...
$(document).ready(function(){
    ...
    $('.tabs .tab1').css('background','#ED1C24').css('color','#fff'); //첫번째 탭메뉴 활성화
    ...
    $('.tabs .tab').each(function (index) {  // index=0 1 2
      $(this).click(function(e){  //각각의 탭메뉴를 클릭하면... 
          ...
          $('.content_area .section_box').css('height','auto');
          ...
          $(this).css('background','#ED1C24').css('color','#fff'); // 클릭한 해당 탭메뉴만 활성화
